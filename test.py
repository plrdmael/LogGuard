...
def process_data_from_csv_file(path_to_file, output_score_file="Ressources/Result/anomalies_score_from_csv.csv", output_anomaly="Ressources/Result/anomalies_from_csv.csv"):
    ...
    feature_columns = ['lenToken', 'lenURL', 'Request','URL']
...
process_data_from_csv_file(path_to_file="Ressources/Normalized/dataNorm.csv",output_score_file="Ressources/Result/training_score.csv",output_anomaly="Ressources/Result/training_anomalie.csv")
